...
import com.cn.featurewanandroidhome.data.QuestionRepositoryImpl
...
import com.cn.featurewanandroidhome.domain.QuestionUseCaseImpl
...
import com.cn.featurewanandroidhome.presentation.composable.QuestionViewModel
...
internal fun loadDataModule() = module {
    ...
    single { QuestionRepositoryImpl(get()) } bind QuestionRepository::class
}
...
internal fun loadDomainModule() = module {
    ...
    single { QuestionUseCaseImpl(get()) } bind QuestionUseCase::class
}
